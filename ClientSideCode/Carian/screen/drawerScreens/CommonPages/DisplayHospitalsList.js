            ...
            <ScrollView>
                <View style={styles.container}>
                    {this.state.hospitalsList.map(hospital => (
                        <TouchableOpacity  onPress={() => this.onPressingHospital(hospital.name)} key={hospital.name} style={{ width: '100%', flex: 1, backgroundColor: "#F0F0E1", alignItems: "center", justifyContent: 'center' }}>
