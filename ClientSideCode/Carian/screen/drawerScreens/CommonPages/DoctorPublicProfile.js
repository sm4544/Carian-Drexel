        ...
        <ScrollView>
            ...
            <View style={styles.setFlexRow}>
              ...
              <View style={styles.imageRightPosition}>
                <Text style={styles.cardText}>
                  Dr. {this.state.profileD.name}({this.state.profileD.highestDegree})
                </Text>
                <Text style={styles.cardSubBoldText}>
                  {this.state.profileD.specialization}
                </Text>
                <Text style={styles.cardSubItalicText}>
                  {this.state.profileD.overAllExperience} Years of over all experience
                </Text>
                <Text style={styles.cardSubBoldText}>
                  {this.state.profileD.avgRating}({this.state.profileD.totalNoOfReviews} Stories )
                </Text>
          ...
          <View style={styles.hospitalSectionView}>
            <View style={styles.hospitalSectionSubView}>
              <Text style={styles.hospitalName}>{this.state.profileD.hospital_name}</Text>
              ...
              <View style={styles.hospitalDataRow}>
                ...
                <View>
                  ...
                  <Text style={styles.adressText}>
                    {' '}
                    {this.state.profileD.area}, {this.state.profileD.city} ,{hospital.state},{' '}
                    {hospital.pincode}
                  </Text>
                </View>
              </View>
        ...
        <View style={styles.footerView}>
          ...
          <View>
            <TouchableOpacity
              ...
              <Text style={styles.payButtonText}>Continue ${this.state.profileD.doctor_fee}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
