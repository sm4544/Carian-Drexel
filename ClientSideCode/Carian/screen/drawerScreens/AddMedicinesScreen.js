...
export default class AddMedicinesScreen extends ValidationComponent {
  ...
  onPressSubmit = (appointment_id, patient_id, hospital_id) => {
    ...
    body = JSON.stringify({ "appointment_id": appointment_id, "patient_id": patient_id, "hospital_id": hospital_id, "doctor_id": profileId, "pharmacy_id": this.state.pharmacy_id, "order_status": "Initiated", "medicines": this.state.dataTable })
    console.log(body)
