    ...
    return (
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={styles.footerView}>
          ...
          <View style={{ flexDirection: "row" }}>
            <TouchableOpacity onPress={() => this.props.navigation.navigate('HospitalDetailsScreen', {
              name: name, area: area, city: city, phonenumber: phonenumber, addressine1: addressine1, addressine2: addressine2,
              state: state, pincode: pincode, licence_number: licence_number, originally_registered_date: originally_registered_date, id: id
            })} activeOpacity={0.7} style={styles2.button} >
