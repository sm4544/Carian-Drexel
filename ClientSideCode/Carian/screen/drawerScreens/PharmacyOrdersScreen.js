...
const orders= [{
  ...
  tablets : [[ "assytrome" ,'10mg',"5"], [ "paracetemol",'650mg',"10"] , ["HCQS",'200mg',"10"]]  
  },
  {
    order_id : "1114",
    patient_name: "Mahesh",
    ...
    order_date : '03/06/2021',
    tablets : [[ "Hydroxy" ,'10mg',"5"], [ "Chlorophill",'650mg',"10"] , ["HCQS",'100mg',"10"]]
    },
    {
      order_id : "1999",
      patient_name: "Yogi",
      ...
      order_date : '03/06/2021',
      tablets : [[ "Asuurance" ,'1mg',"10"], [ "paracetemol",'650mg',"10"] , ["HCQS",'200mg',"10"]]
      },
      {
        order_id : "1034",
        ...
        tablets : [[ "citrizen" ,'10mg',"5"], [ "Dolo",'650mg',"10"] , ["karval plus",'200mg',"10"]] 
        }]

export default class PharmacyOrderScreen extends ValidationComponent {
  constructor(props) {
    super(props);
    this.state = {     
      flagDep: false,
  ...
  render() {
    ...
    const element = (data, index) => (
      <TouchableOpacity onPress={() => {this.orderinfo(index),this.props.navigation.navigate('MedicineOrderViewScreen', { order_id : this.state.order_id,
      ...
      order_date : this.state.order_date, tableData:this.state.tablets})}}>
