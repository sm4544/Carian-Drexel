...
describe('<PharmacyOverview/>', () => {
    beforeEach(function () {
        ...
        wrapper = shallow(<PharmacyOverview navigation={navigation}></PharmacyOverview>);
    });
    ...
    it('should navigate to PharmacyDetailsScreen screen component after clicking on edit', () => {
