...
describe('<AddLabReportsScreen/>', () => {
    ...
    it('should have ScrollView', () => {
      ...
      it('should have Text ADD ', () => {
        expect(wrapper.find( <Text style={{alignItems:'center',alignContent:'center',borderRadius:18,height:50,width:40,fontSize:20,fontStyle:'italic',color:'black',paddingBottom:30}}>ADD</Text>));
      });
