...
describe('<PatientDetailsScreen/>', () => {
  beforeEach(function () {
    ...
    patientDoctorDetailsApi.mockResolvedValue([{
      doctorname: "abc" + " " + "ghj", specialization: "mbbs", overall_work_experience: "7"
  ...
  it('should navigate to PatDoctorDetails screen', () => {
    ...
    sinon.assert.calledWith(spyon, "PatDoctorDetails", {
      doctorname: "abc" + " " + "ghj", specialization: "mbbs", overall_work_experience: "7", studied_at: "gandhi",
  ...
  it('should navigate to HealthInformationDetails screen', () => {
    ...
    sinon.assert.calledWith(spyon, "HealthInformationDetails", {
      patient_blood_group: "O+", patientweight: "40",
