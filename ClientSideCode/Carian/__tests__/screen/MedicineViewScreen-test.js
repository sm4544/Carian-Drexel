...
import { getMyPharmacyMedicine , getAllMedicine } from '../../screen/services/MedicineService';
...
let tableHead= ['S.NO', 'Medicine Name', 'content'];
let tableData= ['1','paracet','100mg'];

describe('<MedicineViewScreen/>', () => {
    beforeEach(function () {
      spyon = sinon.spy(navigation, 'navigate');
    getMyPharmacyMedicine.mockResolvedValue([{ pharmacy: global.profileid}]);
    getAllMedicine.mockResolvedValue([{ id: "1", name: "paracet" }]);
      wrapper = shallow(<MedicineViewScreen navigation={navigation}></MedicineViewScreen>);
    });
    afterEach(function () {
